const checkboxItem = document.querySelector(".map__toggle-input"),
  checkboxText = document.querySelector(".map__toggle-text"),
  mapInner = document.querySelector(".map__inner"),
  mapCards = document.querySelector(".map__cards"),
  mapCardsWrapper = document.querySelector(".map__cards-wrapper");
function initMap() {
  const n = new google.maps.Map(document.querySelector(".map__content"), {
    zoom: 9.8,
  ...
  const a = [
    ...
    (n) => (
      (n.image = "images/pin.svg"), (n.activeImage = "images/redpin.svg"), n
    )
  );
  a.forEach((p) => {
    (p.marker = new google.maps.Marker({
      ...
      p.info && p.marker.addListener("click", e);
  });
  const s = document.querySelector("#controls");
  function e() {
    const s = a.find((n) => n.marker === this);
    p.setContent(s.info), p.open(n, this), i(this);
  }
  function i(n) {
    a.forEach((p) =>
      p.marker.setIcon(n === p.marker ? p.activeImage : p.image)
    );
  }
  ...
  (s.innerHTML = a
    ...
    s.addEventListener(
      ...
      ({
        ...
        n && google.maps.event.trigger(a[n].marker, "click");
      }
    );
}
